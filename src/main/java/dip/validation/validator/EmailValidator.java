 ...
 * @author nocquidant
 */
public class EmailValidator extends AbstractBusinessValidator {
  ...
  public EmailValidator(String violationCode) {
    super(violationCode);
  }
  ...
  public boolean isValid() {
    ...
    if (!(getValue() instanceof String)) {
      throw new IllegalArgumentException("Value must be instance of String: " + getValue().getClass());
    }
